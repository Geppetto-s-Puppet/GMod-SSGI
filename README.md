...
```
あとは`ps20b`の慣習を捨てて`ps30`に。命名規則も統一し、空を`discard`後、ビットマスクを疑似再現するとSSGIとSSAOは……
![Image](https://github.com/user-attachments/assets/1d0c6af8-f259-4f5c-ac8f-8b7da7f41d79)
![Image](https://github.com/user-attachments/assets/ae480b97-662f-4a1a-b61e-409694887f19)
うん。ノイズが酷くて重い。理想は計算時の解像度を1/8にすることだが、G-Bufferはミップマップを生成しない上、アップスケーリングの手法が未知。